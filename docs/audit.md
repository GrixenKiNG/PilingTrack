...
**Закрыто за период 2026-04-30 → 2026-05-23:** 30 пунктов. Единственный остающийся открытый пункт — M-3 (миграции Prisma), процессный, закрывается дисциплиной авторов PR. M-2 (npm vulns) задокументирован в README; L-2 (magic sizes) полностью устранён.
...
К 2026-05-23: 9 миграций (тренд верный — миграции дробятся). Не больно сейчас, но ревью миграций по PR превратится в ад если регрессируем.

**Как закрыть:** проводить миграции мельче, по одному смыслу — на каждый PR с моделью. Это дисциплинарное правило, не код.
