...
| 9. Сравнение состояний вход/выход | ждёт решения по способу сопоставления | — |
| 10. Ветер из погодного сервиса | не начата | — |
| 11. Экран оператора | ждёт решения «кто жмёт пуск» | — |
| 12. Финальная проверка | не начата | — |
