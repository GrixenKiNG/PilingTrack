...
// Re-export the content layer so existing importers keep working unchanged.
export {
  buildMediaKey,
  contentMatchesMagicBytes,
  getExtensionForContentType,
...
export function getMediaService(): MediaService {
  if (!_mediaService) {
    const config: MediaServiceConfig = {
      ...
      // eslint-disable-next-line @typescript-eslint/no-non-null-assertion -- non-null invariant established earlier in this function
      allowedContentTypes: DEFAULT_MEDIA_CONFIG.allowedContentTypes!,
      // eslint-disable-next-line @typescript-eslint/no-non-null-assertion -- non-null invariant established earlier in this function
      thumbnailWidth: DEFAULT_MEDIA_CONFIG.thumbnailWidth!,
      // eslint-disable-next-line @typescript-eslint/no-non-null-assertion -- non-null invariant established earlier in this function
      urlExpiresIn: DEFAULT_MEDIA_CONFIG.urlExpiresIn!,
    };
