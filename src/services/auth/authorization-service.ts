...
const abilityRoles: Record<Ability, Role[]> = {
  ...
  // и инженер ОТ из-за этого не видели машину, по которой сами работают:
  // механик её обслуживает, инженер ОТ ведёт по ней осмотры и наряды-допуски
  // и решает, выпускать ли её в смену.
  'equipment.read': ['ADMIN', 'DISPATCHER', 'MECHANIC', 'SAFETY_ENGINEER'],
