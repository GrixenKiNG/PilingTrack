 ...
 *
 * ОТКУДА ЧАСЫ. Из расписания организации (владелец, 23.09.2026): дневная
 * 07:00–19:00, ночная 19:00–07:00 следующих суток. Ровно это подписано на самой шкале.
...
export const SHIFT_WINDOW = {
  ...
  NIGHT: {startHour: 19, endHour: 31}, // 31 = 07:00 следующих суток
} as const;
 ...
 * `hour` может быть больше 23: 31 означает 07:00 следующего дня.
 */
