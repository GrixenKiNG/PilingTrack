/**
 * Generic layout renderer (shared editor engine): renders a template's grid
 * of blocks; block CONTENT comes from the surface via `renderBlockContent`.
 * Extracted from the monitoring equipment-tile renderer.
 */

import { cn } from '@/lib/utils';
import type { LayoutBlock, LayoutTemplate } from './layout-template';

export type RenderBlockContent = (block: LayoutBlock) => React.ReactNode;
...
function blockStyle(block: LayoutBlock): React.CSSProperties {
