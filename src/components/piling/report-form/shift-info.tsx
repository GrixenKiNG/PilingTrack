    ...
    <>
      <Card>
        <CardContent className="p-4 space-y-3">
          <div className="space-y-1.5">
            <Label className="text-base font-semibold text-slate-800 flex items-center gap-1.5"><PilingIcon name="calendar" size={14} decorative />Дата</Label>
            <Input type="date" value={date} onChange={(e) => onDateChange(e.target.value)} className="h-11 font-mono" />
          </div>
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-1.5"><Label className="text-base font-semibold text-slate-800">Начало смены</Label>
              <Input type="time" value={shiftStart} onChange={(e) => onShiftStartChange(e.target.value)} className="h-11 font-mono" /></div>
            <div className="space-y-1.5"><Label className="text-base font-semibold text-slate-800">Конец смены</Label>
      ...
      <Card>
        <CardContent className="p-4">
          <div className="space-y-1.5">
            <Label className="text-base font-semibold text-slate-800 flex items-center gap-1.5"><PilingIcon name="site" size={14} decorative />Объект</Label>
      ...
      <Card>
        <CardContent className="p-4">
          <div className="space-y-1.5">
            <Label className="text-base font-semibold text-slate-800 flex items-center gap-1.5"><PilingIcon name="equipment-rig" size={14} decorative />Установка</Label>
