        ...
        <button onClick={onSubmit} disabled={submitting}
          className={cn(
            ...
            submitting ? 'bg-orange-400 text-white cursor-wait'
              : (!selectedSiteId || !hasEntries) ? 'bg-orange-500/20 text-orange-400 cursor-pointer hover:bg-orange-500/30'
