  ...
  const summaryCards = [
    {
      ...
      cardClass: 'border-emerald-300 bg-gradient-to-br from-emerald-100 via-emerald-50 to-stone-50',
    ...
    },
    {
      ...
      cardClass: 'border-blue-300 bg-gradient-to-br from-blue-100 via-blue-50 to-stone-50',
    ...
    },
    {
      ...
      cardClass: 'border-slate-300 bg-gradient-to-br from-slate-100 via-slate-50 to-stone-50',
      iconClass: 'bg-slate-600 text-white shadow-sm',
    ...
    },
    {
      ...
      cardClass: 'border-amber-300 bg-gradient-to-br from-amber-100 via-amber-50 to-stone-50',
