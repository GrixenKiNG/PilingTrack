                  ...
                  <article key={section.id} className="rounded-xl border border-border">
                    ...
                    <div className="overflow-x-auto">
                      ...
                      {section.items.map((item, index) => (
                        <div key={item.id} className="grid min-w-[620px] grid-cols-[44px_minmax(0,1fr)_130px_92px_66px] items-center gap-2 border-b border-border px-3 py-2 text-2xs last:border-b-0">
