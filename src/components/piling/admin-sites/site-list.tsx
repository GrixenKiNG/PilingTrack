                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 flex-wrap">
                      ...
                      {!site.isActive && (
                        <Badge variant="secondary" className="text-3xs bg-slate-200 text-slate-500">
                          Неактивен
                        </Badge>
                      )}
                      {site._count && (site._count.pilePlans > 0 || site._count.drillingPlans > 0) && (
                        <div className="flex items-center gap-1.5 ml-1">
                          {site._count.pilePlans > 0 && (
                            <Badge variant="outline" className="text-3xs text-orange-600 border-orange-200 bg-orange-50">
                              {site._count.pilePlans} план{site._count.pilePlans > 1 ? 'а' : ''} свай
                            </Badge>
                          )}
                          {site._count.drillingPlans > 0 && (
                            <Badge variant="outline" className="text-3xs text-blue-600 border-blue-200 bg-blue-50">
