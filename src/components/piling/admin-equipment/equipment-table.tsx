          ...
          {sorted.map((c) => {
            ...
            return (
              ...
              >
                ...
                <td className="break-words text-muted-foreground">{c.assignedSiteName ?? '—'}</td>
                <td className="text-muted-foreground"><WordStack value={c.assignedCrewName} /></td>
                <td className="text-muted-foreground"><WordStack value={c.assignedOperatorName} /></td>
                <td>
                ...
                <td>
                  ...
                  <div className="text-xs leading-tight text-muted-foreground" title={c.downtimeReason ?? ''}>
                    <WordStack value={c.downtimeReason} />
                  </div>
                </td>
                <td className="truncate font-mono text-foreground">{c.engineHoursTotal?.toLocaleString('ru') ?? '—'}</td>
