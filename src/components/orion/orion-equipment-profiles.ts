...
export const orionEquipmentProfiles: Record<OrionEquipmentProfileKey, OrionEquipmentProfile> = {
  'pve-50pr': {
    ...
    source: { label: 'PVE — 50PR technical brochure', url: 'https://www.agd-equipment.co.uk/images/articles/large/folder_pve_piling_1005_lr.pdf' },
  ...
  'banut-655': {
    ...
    source: { label: 'Banut — техническая спецификация 655', url: 'https://www.prommashini.ru/upload/burovie_ust/BANUT%20655.pdf' },
  ...
  'bauer-rtg-rm20': {
    ...
    source: { label: 'RTG Rammtechnik — RM 20 specification (03/2016)', url: 'https://www.agd-equipment.co.uk/images/pdf/RTG_RM20_Specification_Details.pdf' },
