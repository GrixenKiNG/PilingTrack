 ...
 *
 * Экран работает на ЖИВЫХ данных: то же состояние смены и те же команды, что
 * у `/operator`. Раньше здесь стояли цифры макета (Сидоров А. В., Liebherr
 * LRH 100, наряд № 118) — эта строка пережила перевод модуля на настоящий
 * контур и вводила в заблуждение того, кто открывал файл.
 *
