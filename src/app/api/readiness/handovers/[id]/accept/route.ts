...
export const POST = withReadinessCommand(async (request: NextRequest, context, {params}: Params) => { const {id} = await params; const parsed = acceptHandoverSchema.safeParse(await readJsonBody(request));
